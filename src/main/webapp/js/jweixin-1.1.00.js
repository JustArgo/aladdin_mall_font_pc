!function(a, b) {
    ...
    function h(a, b, c) {
        var d, e, f;
        switch ("openEnterpriseChat" == a && (b.errCode = b.err_code),
        delete b.err_code,
        delete b.err_desc,
        delete b.err_detail,
        d = b.errMsg,
    ...
    if (!a.jWeixin)
        ...
        G = {
            ...
            onMenuShareTimeline: function(a) {
				console.log("onMeshareTimeline-->");
				console.log(a);
				console.log("p.onMenuShareTimeline-->"+p.onMenuShareTimeline)
